...
//被预约的课(私课)
export function formatgetPrivateCourse(list) {
  return list.map(item=>this.formatgetPrivateCourseItem(item))
}
export function formatgetPrivateCourseItem(item){
  return {
    flag:item.flag,
...
//被预约的课(团课)
export function formatgetLeagueCourse(list) {
  return list.map(item=>this.formatgetLeagueCourseItem(item))
}
export function formatgetLeagueCourseItem(item){
  return {
    flag:item.flag,
    start_time:item.start_time,
    end_time:item.end_time,
...
//课程安排
export function formatgetCourseArrange(list) {
  return list.map(item => this.formatgetCourseArrangeItem(item))
}

export function formatgetCourseArrangeItem(item) {
  return {
    name:item.mem_name,
