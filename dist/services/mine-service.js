...
//团课简报
export function queryLeagueClass(chosenDate) {
  return jsonGetRequest('yp-xcx-pt-home', {
    custName: appConfig.custName,
    gym: AuthService.getMemberInfo().gym,
    myId: AuthService.getMemberInfo().memId,
...
//私教排课
export function querycourseArrange(chosenDate) {
  return jsonGetRequest('yp-xcx-pt-getPrivateTime', {
    custName: appConfig.custName,
    gym: AuthService.getMemberInfo().gym,
    myId: AuthService.getMemberInfo().memId,
    chosenDate:chosenDate
...
//私教排课 chosenDate为时间段
export function uploadCourseArrange(chosenDate) {
  return urlencodePostRequest('yp-xcx-pt-addPrivateTime', {
    custName: appConfig.custName,
    gym: AuthService.getMemberInfo().gym,
    myId: AuthService.getMemberInfo().memId,
    chosenDate:chosenDate
...
//私教约课 
export function queryMyPriTime(ptId,chosenDate) {
  return jsonGetRequest('yp-xcx-getMyPriTimeArrange', {
    custName: appConfig.custName,
    gym: AuthService.getMemberInfo().gym,
    ptId: ptId,
    chosenDate:chosenDate
...
//私教约课 上传时间日期
export function uploadMyPriOrderTime(ptId,chosenDate,timeRange,id,user_card_id) {
  return urlencodePostRequest('yp-xcx-confirmMyPriOrderTime', {
    custName: appConfig.custName,
    gym: AuthService.getMemberInfo().gym,
    myId: AuthService.getMemberInfo().memId,
    ptId: ptId,
...
//被预约的课获取私课列表 chosenDatew为当日日期
export function getPtPrivateCourse(chosenDate) {
  return jsonGetRequest('yp-xcx-home-getPtPrivateCourse', {
    custName: appConfig.custName,
    gym: AuthService.getMemberInfo().gym,
    myId: AuthService.getMemberInfo().memId,
    chosenDate:chosenDate
...
//被预约的课获取团课列表 chosenDatew为当日日期
export function getPtLeagueCourse(chosenDate) {
  return jsonGetRequest('yp-xcx-home-getPtLeagueCourse', {
    custName: appConfig.custName,
    gym: AuthService.getMemberInfo().gym,
    myId: AuthService.getMemberInfo().memId,
    chosenDate:chosenDate
...
//被预约的课获取团课列表 chosenDatew为当日日期
export function getPtName() {
  return jsonGetRequest('yp-xcx-home-getPtName', {
    custName: appConfig.custName,
    gym: AuthService.getMemberInfo().gym,
    myId: AuthService.getMemberInfo().memId,
  })
...
//教练课程列表扫码销课
export function getQcCode(id,mem_id,user_card_id,flag){
  return jsonGetRequest('yp-xcx-pt-qr',{
    id:id,
    flag:flag,
    mem_id:mem_id,
    user_card_id:user_card_id
